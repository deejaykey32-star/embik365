...
import { CycleDate, AdminUser, AppTheme } from '../types';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#8a5327] to-[#452714] dark:from-amber-600 dark:to-amber-800 text-white flex items-center justify-center shadow-md shadow-[#8a5327]/20 dark:shadow-amber-950/40 border border-[#b47a46]/30 dark:border-amber-500/30 shrink-0">
              <Sparkles className="w-5 h-5 text-[#f6d8ae] dark:text-amber-200" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="font-heading-cinzel font-bold text-xl sm:text-2xl text-[#2a221b] dark:text-[#f3e8d2] tracking-wide">
                  Drogowskazy 365
                </h1>
          ...
          <div className="flex items-center gap-1 sm:gap-2 bg-[#f4ebe1] dark:bg-[#131924] p-1.5 rounded-2xl border border-[#e2d4c3] dark:border-[#212b3c] shadow-inner">
            <button
              ...
              className="p-2 rounded-xl hover:bg-[#eae0d2] dark:hover:bg-[#1c2434] text-[#4d3d2e] dark:text-[#cbd5e1] transition-colors active:scale-95 cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white dark:bg-[#1a2230] hover:bg-[#faf6f0] dark:hover:bg-[#222c3d] border border-[#dacabb] dark:border-[#2d3a4f] text-[#2c221a] dark:text-[#f1f5f9] shadow-xs transition-all active:scale-98 cursor-pointer"
            >
          ...
          {/* Right Action Bar: Theme Switcher + Admin Profile */}
          <div className="flex items-center gap-2">
            ...
            {adminUser ? (
              ...
              >
                ...
                <div className="text-left hidden lg:block">
                  <div className="text-xs font-semibold leading-tight text-white">Admin Dominik</div>
                  <div className="text-[10px] text-[#c7b9ab] dark:text-[#94a3b8] leading-none">GitHub / PDF / Edycja</div>
                </div>
                <span className="lg:hidden text-xs font-bold text-amber-300">Admin</span>
              </button>
            ) : (
              <button
                onClick={onOpenAdmin}
              ...
              >
                ...
                <span className="hidden sm:inline">Konto Administratora</span>
